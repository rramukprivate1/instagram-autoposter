        ...
        <div className="card mb-6">
          ...
          <div className="slider-wrapper">
            <div className="slider-row">
              ...
              />
              <span className="slider-value">/ day</span>
            </div>
          </div>
          ...
          <p className="text-sm text-muted mt-2">
            This controls how many candidates get <strong>generated and queued</strong> for review - with Manual
            Approval on, you can set this as high as you want and still only approve the few you actually like.
            Just know that Instagram itself caps actual <strong>publishing</strong> at 25 posts/24h per account
            regardless of this number, and spreading a very large count across a single day with jitter on can
            cause posting times to bunch close together - worth checking Posting Times below after using Spread
            with a high number.
          </p>
        </div>
